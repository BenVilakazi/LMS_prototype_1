...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, title, course, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    title = (_a.sent()).title;
                    if (!userId || !teacher_1.isTeacher(userId)) {
                        return [2 /*return*/, new server_1.NextResponse("Unauthorized", { status: 401 })];
                    }
                    return [4 /*yield*/, db_1.db.course.create({
                            data: {
                                userId: userId,
                                title: title
                            }
                ...
                case 2:
                    course = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(course)];
                case 3:
                    error_1 = _a.sent();
                    console.log("[COURSES]", error_1);
