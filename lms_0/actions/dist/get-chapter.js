...
exports.getChapter = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var purchase, course, chapter, muxData, attachments, nextChapter, userProgress, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    _b.label = 5;
                case 5:
                    if (!(chapter.isFree || purchase)) return [3 /*break*/, 8];
                ...
                case 7:
                    nextChapter = _b.sent();
                    _b.label = 8;
                case 8: return [4 /*yield*/, db_1.db.userProgress.findUnique({
                        where: {
                            userId_chapterId: {
                                userId: userId,
                                chapterId: chapterId
